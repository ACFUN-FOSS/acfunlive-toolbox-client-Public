<template>
	<div class="outer">
		...
		<title-scrolling class="song-name shadow" style="width:100%" :style="titleStyle"
			:label="`正在播放：${songInfo.name||'暂无播放歌曲'} ${songInfo.author?` - ${songInfo.author}`:''}`" />
	</div>
</template>
...
export default {
	...
	mounted() {
		this.s_wsevent.on("lyric-update", e => {
